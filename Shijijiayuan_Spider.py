...
browser.find_element_by_xpath('//*[@id="hder_login_form_new"]/input[3]').send_keys('account')
browser.find_element_by_xpath('//*[@id="hder_login_form_new"]/input[4]').clear()
browser.find_element_by_xpath('//*[@id="hder_login_form_new"]/input[4]').send_keys('keys')
